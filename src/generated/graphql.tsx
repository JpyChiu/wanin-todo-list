...
export type FetchTodoListSubscription = {
  __typename?: 'subscription_root'
  todo_list: Array<{
    __typename?: 'todo_list'
    assignee?: string | null | undefined
...
export function useInsertTodoListMutation(
  baseOptions?: Apollo.MutationHookOptions<InsertTodoListMutation, InsertTodoListMutationVariables>,
) {
...
export type InsertTodoListMutationOptions = Apollo.BaseMutationOptions<
  InsertTodoListMutation,
  InsertTodoListMutationVariables
>
...
export function useUpdateTodoListMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateTodoListMutation, UpdateTodoListMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export type UpdateTodoListMutationOptions = Apollo.BaseMutationOptions<
...
export function useDeleteTodoListMutation(
  baseOptions?: Apollo.MutationHookOptions<DeleteTodoListMutation, DeleteTodoListMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useGetTodoListQuery(
  baseOptions?: Apollo.QueryHookOptions<GetTodoListQuery, GetTodoListQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useGetTodoListLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetTodoListQuery, GetTodoListQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
 ...
 * });
 */
export function useFetchTodoListSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<FetchTodoListSubscription, FetchTodoListSubscriptionVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSubscription<FetchTodoListSubscription, FetchTodoListSubscriptionVariables>(
